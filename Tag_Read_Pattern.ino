/*
   ...
   -----------------------------------------------------------------------------------------
   RST/Reset   RST          9 (CHANGED TO 7)            5         D9         RESET/ICSP-5     RST
...
#define NFC_RST_PIN         7           // Configurable, see typical pin layout above
#define NFC_SS_PIN          10 //(2)          // Configurable, see typical pin layout above
...
void setup() {
  ...
  Serial.println(F("Read TAG Pattern ID"));
}
